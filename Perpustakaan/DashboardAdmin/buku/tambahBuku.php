...
<nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item"><a class="nav-link active" href="../dashboardAdmin.php">Dashboard</a></li>
        <li class="nav-item"><a class="nav-link text-success" href="daftarBuku.php">Browse</a></li>
      </ul>
    </div>
  </div>
</nav>
    ...
    <form action="" method="post" enctype="multipart/form-data" class="mt-3 p-2">
      ...
      <div class="custom-css-form">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="id_buku" placeholder="contoh: inf01" required>
        </div>
      </div>
      ...
      <div class="form-floating mb-3">
        <textarea class="form-control" name="buku_deskripsi" placeholder="Sinopsis Buku" style="height: 100px"></textarea>
