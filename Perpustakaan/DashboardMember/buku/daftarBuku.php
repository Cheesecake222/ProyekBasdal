...
//read buku Akuntansi
if(isset($_POST["Akuntansi"]) ) {
$buku = queryReadData("SELECT * FROM buku WHERE kategori = 'Akuntansi'");
}
//read buku Manajamen
if(isset($_POST["Manajamen"]) ) {
$buku = queryReadData("SELECT * FROM buku WHERE kategori = 'Manajamen'");
}
//read buku Pertanian
if(isset($_POST["Pertanian"]) ) {
$buku = queryReadData("SELECT * FROM buku WHERE kategori = 'Pertanian'");
}
?>
<!DOCTYPE html>
<html lang="en">
     ...
     <div class="p-4 mt-5">
      ...
      <form action="" method="post">
        <div class="layout-card-custom">
         ...
         <button type="submit" name="Hukum" class="btn btn-outline-primary">Hukum</button>
         <button type="submit" name="Akuntansi" class="btn btn-outline-primary">Akuntansi</button>
         <button type="submit" name="Manajamen" class="btn btn-outline-primary">Manajamen</button>
         <button type="submit" name="Pertanian" class="btn btn-outline-primary">Sains</button>
         </div>
        </form>
       </div>
